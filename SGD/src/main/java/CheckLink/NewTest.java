...
//##########WORKING EXTENT REPORT SKELETON CONFIGURATION ********************************##########
...
public class NewTest {
	 ...
	 extent.setSystemInfo("User Name", "SLP");
  ...
  public void f() {
	  ...
	  logger = extent.createTest("Extent Report Test");
	  logger.log(Status.INFO,"Sample");
	  logger.log(Status.PASS,"Sample");
	  extent.flush();
